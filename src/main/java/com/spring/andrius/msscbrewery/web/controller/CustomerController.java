...
public class CustomerController {
    ...
    @PostMapping
    public ResponseEntity<BeerDto> saveNewCustomer(@Valid @RequestBody CustomerDto customerDto) {
    ...
    public void updateBeer(UUID customerId, @Valid @RequestBody CustomerDto customerDto) {
